...
<head>
    ...
    <link rel="icon" href="#">
    <title>NVSU Ordering System</title>
    <!-- Bootstrap core CSS -->
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo.png" alt="" height="30"> NVSU Ordering System</a>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="COP" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Cash on Pickup</span>
                                                    <br> <span>Please send your cheque to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</span> </label>
                                            </li>
                                        </ul>
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <div class="row top-footer">
                        ...
                        <a href="#"> <img src="images/logo.png" alt="Footer logo" height="60"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
